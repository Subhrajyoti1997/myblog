package com.blog.myblog5.security;
...
//this below method compulsory to override after then we can modify
    @Override
    //this method is built in
    public UserDetails loadUserByUsername(String usernameOrEmail) throws UsernameNotFoundException {
       ...
       //here above User os a inbuilt class
    }
